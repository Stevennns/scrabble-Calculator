...
public class Bool implements ITipos {
    ...
    /** Calcula la resta entre tipo de la clase y un tipo de cl.uchile.dcc.scrabble.gui.Vista.Scrabble */
    @Override
    ...
    /** Calcula la multiplicación entre tipo de la clase y un tipo de cl.uchile.dcc.scrabble.gui.Vista.Scrabble */
    @Override
    ...
    /** Calcula la division entre tipo de la clase y un tipo de cl.uchile.dcc.scrabble.gui.Vista.Scrabble */
    @Override
